...
public class CollapsingToolbarLayoutFragment extends BaseFragment {
    ...
    protected int getLayoutId() {
        ...
        return R.layout.fragment_ui_collapsingtoobar_layout;
    }
    ...
    public void onResume() {
        ...
        childToolBar.setSubtitle("CollapsingToobarLayout");
    }
    ...
    protected void initData() {
        ...
        testData();
        adapter = new RecyclerViewWaterfallsAdapter(CollapsingToolbarLayoutFragment.this, listTest);
        //listView 样式
